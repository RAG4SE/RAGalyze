...
class DeepSeekClient(ModelClient):
    ...
    DeepSeek provides high-performance AI models through an OpenAI-compatible API.
    ...
    def __init__(
        ...
        self.base_url = base_url or os.getenv(self._env_base_url_name, "https://api.deepseek.com")
    ...
    async def acall(
        ...
        """Async call to the DeepSeek API."""
