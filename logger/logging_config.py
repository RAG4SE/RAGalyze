...
class TqdmCompatibleLogger(logging.Logger):
    ...
    def _handle_tqdm_output(self, message, level_name, color_code="", icon=""):
        ...
        try:
            ...
            formatted_message = padded_icon + f"{color_code}[RAGalyze.{module_path}] {stripped_message}\033[0m"
            ...
            try:
                ...
                if stripped_message and ('|' in stripped_message and '%' in stripped_message):
                    ...
                    if self._current_line:  # If we had a progress bar, add newline first
                        print()
                        self._current_line = ""
