...
'''
bm25_keywords = "[FUNC]CodeTransform::operator() [CALL]builtin [FUNC]builtin"
faiss_query = "CodeTransform::operator() calls builtin, and builtin's definition"
faiss_query = ""
