...
"""Tests for :class:`AnalyzeFunctionTypeQuery`."""
...
from ragalyze.agent import AnalyzeFunctionTypeQuery


class AnalyzeFunctionTypeQueryTests(TestCase):
    def setUp(self) -> None:
        self.query = AnalyzeFunctionTypeQuery(debug=False)
    ...
    def test_cpp_simple_function(self) -> None:
        ...
        self.assertEqual(result["parameter_types"], ["int", "int"])
        self.assertEqual(result["return_types"], ["int"])

    def test_cpp_method_with_qualifiers(self) -> None:
        snippet = "const std::string& MyClass::name() const { return value_; }"
        result = self.query(snippet, language="cpp")
        self.assertEqual(result["parameter_types"], [])
        self.assertEqual(result["return_types"], ["const std::string&"])
    ...
    def test_java_static_method(self) -> None:
        ...
        self.assertEqual(result["parameter_types"], ["String"])
        self.assertEqual(result["return_types"], ["Optional<String>"])
    ...
    def test_python_with_annotation(self) -> None:
        ...
        self.assertEqual(result["parameter_types"], ["dict"])
        self.assertEqual(result["return_types"], ["list"])

    def test_python_constructor_returns_none(self) -> None:
        snippet = "class Example:\n    def __init__(self, value):\n        self.value = value"
        result = self.query(snippet, language="python")
        self.assertEqual(result["parameter_types"], ["unknown"])
        # Python __init__ doesn't have return_types in the result (implicit None)
        self.assertEqual(result["return_types"], None)
    ...
    def test_solidity_function(self) -> None:
        ...
        self.assertEqual(result["parameter_types"], [])
        self.assertEqual(result["return_types"], ["uint256"])
    ...
    def test_java_stream_return(self) -> None:
        ...
        result = self.query(snippet, language="java")
        self.assertEqual(result["return_types"], ["Stream<String>"])

    def test_java_completable_future_return(self) -> None:
        snippet = "public CompletableFuture<Integer> calculateAsync() { /* ... */ }"
        result = self.query(snippet, language="java")
        self.assertEqual(result["return_types"], ["CompletableFuture<Integer>"])
    ...
    def test_java_boolean_return(self) -> None:
        ...
        result = self.query(snippet, language="java")
        self.assertEqual(result["return_types"], ["boolean"])
    ...
    def test_python_generator_return(self) -> None:
        ...
        result = self.query(snippet, language="python")
        self.assertEqual(result["return_types"], ["Iterator[int]"])
    ...
    def test_python_context_manager_return(self) -> None:
        ...
        result = self.query(snippet, language="python")
        self.assertEqual(result["return_types"], ["ContextManager[TextIOWrapper]"])
    ...
    def test_lambda_function(self) -> None:
        ...
        result = self.query(snippet, language="python")
        self.assertEqual(result["return_types"], ["unknown"])

    def test_function_with_multiple_returns(self) -> None:
        snippet = "def get_value(flag):\n    if flag:\n        return 42\n    else:\n        return \"hello\""
        result = self.query(snippet, language="python")
        self.assertEqual(result["return_types"], ["int | string"])
    ...
    def test_function_with_default_args(self) -> None:
        ...
        result = self.query(snippet, language="python")
        self.assertEqual(result["return_types"], ["str"])

    def test_function_with_varargs(self) -> None:
        snippet = "def sum_all(*args):\n    return sum(args)"
        result = self.query(snippet, language="python")
        self.assertEqual(result["parameter_types"], ["*args"])
        self.assertEqual(result["return_types"], ["int"])
    ...
    def test_function_with_annotations_and_defaults(self) -> None:
        ...
        result = self.query(snippet, language="python")
        self.assertEqual(result["return_types"], ["bool"])
    ...
    def test_cpp_operator_overload_return(self) -> None:
        ...
        result = self.query(snippet, language="cpp")
        self.assertEqual(result["return_types"], ["Matrix"])
    ...
    def test_python_static_method_return(self) -> None:
        ...
        result = self.query(snippet, language="python")
        self.assertEqual(result["return_types"], ["DataObject"])
    ...
    def test_solidity_multiple_return_values(self) -> None:
        ...
        result = self.query(snippet, language="solidity")
        self.assertEqual(result["return_types"], ["string memory", "address", "bool"])
    ...
    def test_solidity_struct_return(self) -> None:
        ...
        result = self.query(snippet, language="solidity")
        self.assertEqual(result["return_types"], ["User memory"])
